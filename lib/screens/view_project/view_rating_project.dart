...
class ViewRatingProject extends StatelessWidget {
  ...
  const ViewRatingProject({super.key,required this.project,required this.cubit, this.onSave});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  Text(
                    ...
                    style: const TextStyle(color: AppConstants.textGrayColor,fontSize: 15),
                  ),
                  const SizedBox(height: 20),
                  const RatingField(title: 'Idea', iconToAdd: Icon(Icons.lightbulb, color: AppConstants.orange,)),
                  const SizedBox(height: 20),
                  const RatingField(title: "Design", iconToAdd: Icon(Icons.color_lens_outlined, color: Color(0xffF565BB),)),
                  const SizedBox(height: 20,),
                  const RatingField(title: "Tools",iconToAdd: Icon(Icons.keyboard_command_key_sharp,color: AppConstants.brownIcon,)),
                  const SizedBox(height: 20,),
                  const RatingField(title: "Practices",iconToAdd: Icon(Icons.shape_line_outlined,color: AppConstants.blue,)),
                  const SizedBox(height: 20),
                  const RatingField(title: "Presentation",iconToAdd: Icon(Icons.screenshot_monitor_outlined,color: Color(0xffff8c2c),)),
                  const SizedBox(height: 20),
                  const RatingField(title: "Investment",iconToAdd: Icon(Icons.attach_money_sharp,color: Colors.green,)),
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              ...
                              side: const BorderSide(color: Colors.green,width: 2), // Blue border
                            )
                          ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(5), // Square shape (no rounded corners)
                              side: const BorderSide(color:AppConstants.iconsGrayColor,width: 2), // Blue border
                            )
                          ),
