                  ...
                  padding: const EdgeInsets.all(16),
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: shared.canEdit(project: project) == false ? null
                                : () async {
                                              ...
                                              onPressed: () async {
                                                if (formKey.currentState!.validate()) {
                                                  await cubit.addMember(
                                                    projectId: project.projectId,
                                                    currentMembers: project.membersProject
                                                  );
                                                }
                                              },
                                            )
                        ...
                        : ViewProjectTitle(title: 'Settings', project: project),
                        GetIt.I.get<AuthLayer>().currentUser!.id != project.adminId ? const SizedBox.shrink()
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                RadioListTile(
                                  ...
                                  onChanged: (v) => cubit.setCurrentState(value: v.toString())
                                ),
                                RadioListTile(
                                  value: "Private",
                                ...
                                RadioListTile(
                                  ...
                                  onChanged: (v) => cubit.setCurrentRatingState(value: v.toString())
                                ),
                                RadioListTile(
                                ...
                                RadioListTile(
                                  ...
                                  onChanged: (v) => cubit.setCurrentEditingState(value: v.toString())
                                ),
                                RadioListTile(
