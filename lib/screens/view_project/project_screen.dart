  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        ...
        child: Builder(builder: (context) {
          ...
          return BlocListener<v_cubit.ViewProjectCubit,
                  v_cubit.ViewProjectState>(
              listener: (context, state) {
                ...
                if (state is v_cubit.SuccessState) {
                  ...
                  if (state.isAddMember != null && state.isAddMember == true) {
                    context.popAndSave();
                    saveDialog(
                        context: context, msg: "Member is Added Successfully");
                  }
                }
              },
              child: Scaffold(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                              ...
                              child: Column(
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: shared.canEdit(project: project) ==
                                            false
                                        ? null
                                        : () async {
                                            final selectedImage =
                                  ...
                                  Row(
                                      ...
                                      children: List.generate(3, (index) {
                                        List titles = [
                                          ...
                                          project.type,
                                          project.endDate.contains("n")
                                              ? "in progress"
                                              : "${project.endDate.split('-')[1]}/${project.endDate.split('-').first.substring(2, 4)}"
                                        ];
                                        List colors = [
                                          0xffff8c2c,
                                          0xff01e6d5,
                            ...
                            InkWell(
                              ...
                              child: const ProjectIcon(
                                ...
                                icon: Icon(Icons.screenshot_monitor_outlined,
                                    color: Color(0xffff8c2c), size: 18),
                              ),
                            ),
                                    ...
                                    builder: (context) {
                                      return Padding(
                                        ...
                                        child: Container(
                                          width: context.getWidth(),
                                          height:
                                              context.getHeight(divideBy: 2.8),
                                          decoration: const BoxDecoration(
                                              color: AppConstants.mainWhite,
                                              borderRadius: BorderRadius.only(
                                  ...
                                  updateInfo: (p0) async {
                                    if (p0 != null) {
                                      await shared.getProfile(
                                          GetIt.I.get<AuthLayer>().auth!.token);
                                      await homeCubit.refreshHome();
                                      await myProjectsCubit.getMyProjects();
                                    }
                                  },
                            ...
                            // Section 8 : Settings
                            GetIt.I.get<AuthLayer>().currentUser!.id !=
                                    project.adminId
                                ? const SizedBox.shrink()
                                : ViewProjectTitle(
                            ...
                            GetIt.I.get<AuthLayer>().currentUser!.id !=
                                    project.adminId
                                ? const SizedBox.shrink()
                                : BlocBuilder<v_cubit.ViewProjectCubit,
                                        v_cubit.ViewProjectState>(
                                    builder: (context, state) {
                                    if (state
                                        is v_cubit.UpdateRadioButtonState) {
                                      if (state.status != null) {
                                        currentState = state.status!;
                                      }
                                    }
                                    if (state
                                        is v_cubit.UpdateRadioButtonRating) {
                                      if (state.rating != null) {
                                        currentRating = state.rating!;
                                      }
                                    }
                                    if (state
                                        is v_cubit.UpdateRadioButtonEditing) {
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        RadioListTile(
                                          ...
                                          title:
                                              const Text("Do Not Allow Rating"),
                                          groupValue: currentRating,
                                          onChanged: (v) {
                                            cubit.setCurrentRatingState(
                                                value: v.toString());
