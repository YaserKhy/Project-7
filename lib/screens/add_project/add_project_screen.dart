                              ...
                              builder: (context, state) {
                                return TextFormField(
                                  ...
                                  decoration: const InputDecoration(
                                    ...
                                    hintText: 'dd/MM/yyyy',
                                    suffixIcon: Icon(Icons.calendar_today,color: AppConstants.mainPurple),
                                  ),
                                  validator: (value) {
                            ...
                            const SizedBox(height: 30),
                              BlocBuilder<AddProjectBloc, AddProjectState>(
                                builder: (context, state) {
                                  ...
                                  bool allowEditing = state is ChangeEditingValueState ? state.value : true;
                                  return CheckboxListTile(
                                    ...
                                    value: allowEditing,
                                    onChanged: (value) {
                                      context.read<AddProjectBloc>().add(ChangeEditingValueEvent(value: value!));
