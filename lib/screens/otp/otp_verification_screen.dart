                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                const Text('Enter the OTP sent to : ',style: TextStyle(fontFamily: 'Lato',fontSize: 14,fontWeight: FontWeight.w400)),
                                Text(email,style: const TextStyle(fontFamily: 'Lato',fontSize: 14,fontWeight: FontWeight.w600))
                              ],
                            ),
